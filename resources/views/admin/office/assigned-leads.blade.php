            ...
            <div class="dash-tabs d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="dash-tabs-filter multi-btns d-flex gap-3">
                    ...
                    <div class="create-client-btn active d-flex ">
                        ...
                        <a href="javascript:history.back()" class="btn btn-sm me-2 "> Back
                        </a>
                        ...
                        <div class="table-responsive">
                            <table class="example row-border order-column nowrap" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    {{-- @foreach ($assign_lead as $index => $item)
                                         @php
                                            $remark_json = json_decode($item->remark, true);
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $item->folder->folder_name }}</td>
                                            <td>
                                                {{ $assign_lead->where('emp_id', $item->emp_id)->count() }}
                                            </td>
                                    ...
                                    @foreach ($assign_lead as $index => $item)
                                        <tr>
                                            ...
                                            {{-- <td>
                                                <span class="badge succes-bg text-capitalize">
                                                    {{ $item->status }}
                                                </span>
                                            </td> --}}
                                        </tr>
