...
@push('title')
    <title>Dashboard | office_employee</title>
@endpush
...
@section('content')
                        ...
                        <div class="row w-100">
                            ...
                            <div class="col-6">
                                <div class="d-flex align-items-end h-100 gap-2">
                                    ...
                                    <a href="{{ route('office_employee.task_management.index') }}" class="btn btn-secondary w-50 ">
                                        Reset
                                    </a>
                                </div>
                            </div>
                    ...
                    {{-- <div class="filter-btn">
                        <a href="#!" class="d-flex align-items-center gap-2" data-bs-toggle="modal"
                            data-bs-target="#taskfilterModel"> <img
                                src="{{ asset('public/office_employee/assets/images/icons') }}/setting.png" alt="">Filter</a>
                    </div> --}}
                                    ...
                                    @endphp
                                            ...
                                            <td>
                                                <ul class="action-icons d-flex list-unstyled gap-2 mb-0">
                                                    <li>
                                                        <form action="{{ route('office_employee.task_management.delete') }}"
                                                    ...
                                                    <li><a href="{{ route('office_employee.task_management.view', $task->id) }}"><span
    ...
    <div class="modal fade" id="addProjectModel" tabindex="-1" aria-labelledby="addProjectModelLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <form action="{{ route('office_employee.task_management.store') }}" class="w-100" method="post">
                @csrf
                    ...
                    document.querySelectorAll('.edit-task-btn').forEach(button => {
                        button.addEventListener('click', () => {
                            ...
                            const updateUrlTemplate =
                                "{{ route('office_employee.task_management.update', ['id' => ':id']) }}";
