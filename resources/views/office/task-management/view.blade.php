...
@push('title')
    <title>Task Details | office_employee</title>
@endpush
    ...
    <div class="main-content">
        <div class="pages-content card">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('office_employee.task_management.index') }}" class="btn btn-primary">
                    Back to Task List
                </a>
            </div>
            ...
            @if ($task)
                ...
                <div class="p-3 border-bottom bg-light">
                    <form action="{{ route('office_employee.task_management.updateStatus', $task->id) }}" method="POST"
