                        ...
                        <div class="card-body p-0">
                            <div class="row g-0">
                                ...
                                <div class="col-md-4 bg-light text-center p-4 border-end">
                                    ...
                                    <div class="mb-3 "
                                        style=" width: 100%; max-width: 200px; margin: auto; height: 100%; max-height: 200px;">
                                        @if (Auth::guard('office_employees')->user()->profile_image)
                                            <img src="{{ asset('public/uploads/profile/' . Auth::guard('office_employees')->user()->profile_image) }}"
                                                class="rounded-circle shadow" style="height: 100%; width: 100%;">
                                        @else
                                    ...
                                    @if ($office_employees->designation->department->department_name)
                                        <div class="text-muted small">
                                            ...
                                            {{ $office_employees->designation->department->department_name }}
                                        </div>
                                    @endif
                                ...
                                <div class="col-md-8 p-4">
                                    ...
                                    <form action="{{ route('office_employee.profile.update') }}" method="POST"
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="gender" class="form-select" required>
                                                    ...
                                                    <option value="Male"
                                                        {{ Auth::guard('office_employees')->user()->gender == 'Male' ? 'selected' : '' }}>
                                                        Male</option>
                                                    <option value="Female"
                                                        {{ Auth::guard('office_employees')->user()->gender == 'Female' ? 'selected' : '' }}>
                                                        Female</option>
                                                    <option value="Other"
                                                        {{ Auth::guard('office_employees')->user()->gender == 'Other' ? 'selected' : '' }}>
                                                        Other</option>
                                                </select>
                                            </div>
