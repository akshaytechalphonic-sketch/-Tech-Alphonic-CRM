            ...
            <div class="d-flex align-items-center gap-4">
                ...
                <div class="welcome-admin">
                    <h3 class="fs-5 fw-4 mb-0 d-lg-block d-none">Welcome,
                        {{ Auth::guard('office_employees')->user()->name }}</h3>
                </div>
            </div>
                        ...
                        @forelse ($followups as $fups)
                            <li>
                                <a class="dropdown-item"
                                    href="{{ route('office_employee.leads.single_lead', ['id' => $fups->lead_id]) }}">
                                    <strong>You have a new meeting at
                                        {{ date('h:i A', strtotime($fups->time)) }}</strong><br>
                                    {{ $fups->content }}<br>
                                </a>
                            </li>
                        @empty
        ...
        <div class="sidebar sidebar-mob">
            ...
            <div class="sidebar-menu">
                <div class="menu-list">
                    <ul>
                        <li class="menu-item">
                            <a href="{{ route('office_employee.employee_dashboard') }}"
                                class="{{ Request::is('office-employee/dashboard') ? 'active' : '' }}"><img
                        ...
                        <li class="menu-item menu-dropdown">
                            ...
                            <div class="dropdown-menu-sidebar"   style="display: {{ Request::is('office-employee/leads') || Request::is('office-employee/chats') || Request::is('office-employee/meetings') || Request::is('office-employee/task-management*') ? 'block' : 'none' }};">
                                ...
                                <ul>
                                    ...
                                    <li class="dropdown-item-sidebar">
                                        <a href="{{ route('office_employee.chats.index') }}"
                                    ...
                                    <li class="dropdown-item-sidebar d-none">
                                        <a href="#!"><img
                                                ...
                                                alt="" />
                                            <span class="item-name">Setting</span></a>
                                    </li>
                                </ul>
                            </div>
                        </li>
